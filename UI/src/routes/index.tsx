  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background text-foreground selection:bg-primary selection:text-primary-foreground">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* ==================== 2. HERO SECTION ==================== */}
        <section className="max-w-2xl pb-8 pt-6 lg:pt-10">
        ...
        <section id="how-to-play" className="mb-10 scroll-mt-24 rounded-3xl border border-border/80 bg-surface/50 p-6 lg:p-8">
          ...
          <div className="mt-6 overflow-hidden rounded-2xl border border-border/80 bg-border/80 shadow-md grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px">
            {howToPlaySteps.map((s, idx) => (
              <div
                key={s.step}
                className="relative flex flex-col justify-between bg-surface p-5 sm:p-6 transition-colors hover:bg-surface-2/60"
              >
                <div>
                  <div className="flex items-center justify-between">
          ...
          <div className="mt-6 overflow-hidden rounded-2xl border border-border/80 bg-border/80 shadow-md grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px">
            {contestTypes.map((c) => {
              ...
              return (
                <div
                  key={c.title}
                  className="flex flex-col justify-between bg-surface p-5 sm:p-6 transition-colors hover:bg-surface-2/60"
                >
                  <div>
                    <div className="flex items-center justify-between">
        ...
        <section id="why-us" className="mb-10 scroll-mt-24">
          ...
          <div className="mt-6 overflow-hidden rounded-2xl border border-border/80 bg-border/80 shadow-md grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px">
            {advantages.map((adv) => {
              const Icon = adv.icon;
              return (
                <div
                  key={adv.title}
                  className="bg-surface p-5 sm:p-6 transition-colors hover:bg-surface-2/60"
                >
        ...
        <section id="winners" className="mb-10 scroll-mt-24 rounded-3xl border border-border/80 bg-surface/60 p-6 lg:p-8">
          ...
          <div className="mt-6 overflow-hidden rounded-2xl border border-border/80 bg-border/80 shadow-md grid grid-cols-1 md:grid-cols-3 gap-px">
            {winners.map((w) => (
              <div
                key={w.name}
                className="flex flex-col justify-between bg-surface p-5 sm:p-6 transition-colors hover:bg-surface-2/60"
